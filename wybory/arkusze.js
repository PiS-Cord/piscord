...
async function vote(candidate) {
  ...
  // Szybka aktualizacja statystyk (jedna komórka)
...
// ────────────────────────────────────────────────
// Statystyki kandydatów – JEDNA komórka H1 z tekstem + formułami
// ────────────────────────────────────────────────
async function aktualizujStatystykiKandydatow(arkusz = "Arkusz1") {
  ...
  kandydaci.forEach(k => {
    ...
    tekst += `(=IF(COUNTA(F2:F)>0; ROUND(COUNTIF(F2:F;"${k}")/COUNTA(F2:F)*100;1) & "%"; "0%"))\n`;
  });
  tekst += "Łącznie głosów: =COUNTA(F2:F)";
...
// ────────────────────────────────────────────────
// Statystyki województw – JEDNA komórka H2 (uproszczona wersja)
// ────────────────────────────────────────────────
async function aktualizujStatystykiWojewodztw(arkusz = "Arkusz1") {
  ...
  let tekst = "Wyniki według województw:\n";
